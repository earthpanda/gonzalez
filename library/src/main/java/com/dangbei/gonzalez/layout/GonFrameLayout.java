 ...
 */
public class GonFrameLayout extends FrameLayout implements IGonView {
    private GonViewDelegate delegate;

    public GonFrameLayout(Context context) {
        super(context);
        init();
    }

    public GonFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        delegate.initAttributes(context, attrs);
    }

    public GonFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public GonFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
