 ...
 */
public class GonLinearLayout extends LinearLayout implements IGonView {
    ...
    public GonLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        delegate.initAttributes(context, attrs);
    }

    public GonLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public GonLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
