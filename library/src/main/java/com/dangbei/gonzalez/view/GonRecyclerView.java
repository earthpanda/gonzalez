 ...
 */
public class GonRecyclerView extends RecyclerView implements IGonView {
    ...
    public GonRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        delegate.initAttributes(context, attrs);
    }

    public GonRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
