 ...
 */
public class GonRadioGroup extends RadioGroup implements IGonView {
    private GonViewDelegate delegate;

    public GonRadioGroup(Context context) {
        super(context);
        init();
    }

    public GonRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
