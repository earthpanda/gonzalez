 ...
 */
public class GonProgressBar extends ProgressBar implements IGonView {
    private GonViewDelegate delegate;

    public GonProgressBar(Context context) {
        super(context);
        init();
    }

    public GonProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        delegate.initAttributes(context, attrs);
    }

    public GonProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public GonProgressBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
