 ...
 */
public class GonGridView extends GridView implements IGonView {
    ...
    public GonGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        delegate.initAttributes(context, attrs);
    }

    public GonGridView(Context context, AttributeSet attrs, int defStyleAttr) {
