 ...
 */
public class GonHorizontalScrollView extends HorizontalScrollView implements IGonView {
    private GonViewDelegate delegate;

    public GonHorizontalScrollView(Context context) {
        super(context);
        init();
    }

    public GonHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        delegate.initAttributes(context, attrs);
    }

    public GonHorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public GonHorizontalScrollView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
